...
$c_Subscription=$au2matorhook.c_Subscription
...
try {
    ...
    try {
        ...
        foreach ($Res in $ResourceGroups.value) {
            ...
            #$DirPermissions | Add-Member -MemberType NoteProperty -Name SKU -Value $r.skuPartNumber
            #$DirPermissions | Add-Member -MemberType NoteProperty -Name SKUId -Value $r.skuId
